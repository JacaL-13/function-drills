...
console.log(exclaimThree('excitement'))
...
let nameGreeting = nameCheck('Jared')
...
console.log(bestMovie('The Room'))
...
//CODE HERE
function theEliminator(tributes, weakling) {
  for (let i = 0; i < tributes.length; i++) {
    if (tributes[i] === weakling) {
      tributes.splice(i, 1)
      i--
    }
  }
...
console.log(upperString(sampleString))
...
console.log(emailCheck('   myemail@gmail.com    '))
...
let arrayIsAscending = checkArrAsc(sampleArray)
